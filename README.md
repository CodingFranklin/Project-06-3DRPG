...
**The camera follows the movement of the player**: The camera follows the player at all times.

**The player's model is animated**: The "Firing Rifle" animation from Mixamo.com is applied. *(No shooting effect, just a pose.)*
...
**Reports the player's score**: The player gains score by colliding with rats. Each rat starts with **1000 points**, which decreases over time, encouraging quick action for maximum score.
